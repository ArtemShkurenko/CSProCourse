...
var vehicleReportService = new ReportService<Vehicle>(new XmlFileRepository<Vehicle>(),new JsonFileRepository<Vehicle>());
var warehouseReportService = new ReportService<Warehouse>(new XmlFileRepository<Warehouse>(),new JsonFileRepository<Warehouse>());
